...
export default function EntryModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--ink)]/40 px-4 py-4 backdrop-blur-sm sm:py-6">
      <div className="w-full max-w-2xl rounded-[20px] border border-[var(--rule-light)] bg-[var(--paper)] p-5 shadow-[0_1px_2px_rgba(14,26,38,0.04),0_8px_24px_-8px_rgba(14,26,38,0.12)] transition-all duration-200 animate-[fadeIn_200ms_ease-out] sm:p-6">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          {showNewCategoryInput ? (
            <div className="rounded-lg border border-dashed border-[var(--rule-light)] bg-white/70 p-4">
              ...
              <input
                ...
                className="mt-3 w-full rounded-lg border border-[var(--rule-light)] bg-white px-3 py-2.5 text-sm outline-none transition-all duration-150 focus:border-[var(--ledger)] focus-visible:ring-2 focus-visible:ring-[var(--ledger)]/20"
          ...
          <label className="block text-sm font-medium text-[var(--ink)]">
            ...
            <textarea
              ...
              className="min-h-28 w-full rounded-lg border border-[var(--rule-light)] bg-white px-3 py-2.5 text-sm outline-none transition-all duration-150 focus:border-[var(--ledger)] focus-visible:ring-2 focus-visible:ring-[var(--ledger)]/20"
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-[var(--rule-light)] pt-4 sm:flex-row sm:justify-end">
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg border border-[var(--rule-light)] bg-white px-4 py-2.5 text-sm font-medium text-[var(--ink)] transition-all duration-150 hover:bg-[var(--paper)] focus-visible:ring-2 focus-visible:ring-[var(--ledger)] focus-visible:ring-offset-2"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center justify-center gap-2 rounded-lg bg-[var(--ledger)] px-4 py-2.5 text-sm font-medium text-white transition-all duration-150 hover:bg-[var(--ledger-dim)] active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-[var(--ledger)] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-70"
            >
